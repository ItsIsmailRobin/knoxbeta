...
module.exports = {
  ...
  execute: async (message, args, client, prefix) => {
    const msg = await message.channel.send(`<a:pristo_loading:1119466187919740929> | Turning on **Speed**. This may take a few seconds...`);
...
const sbed = new MessageEmbed()
    .setDescription(`<a:pristo_tick:1119464374608855040> | **Speed** Filter Is Now **Enabled**`)
    .setColor("2f3136");
